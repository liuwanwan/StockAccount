...
public class MainActivity extends AppCompatActivity
{
    ...
    private void addStock()
	{
		...
		final RadioButton rbBuy=(RadioButton)v.findViewById(R.id.rb_exchange_buy);
		final RadioButton rbSell=(RadioButton)v.findViewById(R.id.rb_exchange_sell);
        ...
        builder.setPositiveButton("确定", new DialogInterface.OnClickListener() {
				...
				public void onClick(DialogInterface p1, int p2)
				{
					...
					{//num属性里已限制为整数,cost属性里已限制为数字,tax单位是万分之一
						StockInfo myStockInfo=new StockInfo(MainActivity.this, code, num, cost, exchange);
					}
					else
					{
